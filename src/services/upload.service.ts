...
export class UploadService {
  ...
  resizeImage(file, product: any = null, user: any = null, variationOption: any = null, promaotion: any = null, compressor: any = null) {
  ...
  doneUplaoding(response: any, product, user, variationOption, promaotion,compressor: any) {
    if (response) {
      if (product) {
