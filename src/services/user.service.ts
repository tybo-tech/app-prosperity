...
import { ADD_USER_COMPANY_URL, ADD_USER_URL, GET_ALL_USERS_URL, GET_USERS_BY_COMPANY_URL, GET_USERS_URL, GET_USER_URL, UPDATE_USER_URL } from 'src/shared/constants';
...
export class UserService {
  ...
  getUsersByCompanyId(companyId: string) {
    return this.http.get<User[]>(`${this.url}/${GET_USERS_BY_COMPANY_URL}?CompanyId=${companyId}`)
  }
  getAllUsersStync() {
