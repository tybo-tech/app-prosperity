...
import { ADMIN, TEACHER, IMAGE_DONE, SUPER, TITLES } from 'src/shared/constants';
  ...
  save() {
    ...
    this.userService.addUserCompany(this.newUser).subscribe(data => {
      ...
      if (data && data.UserId) {
        ...
        this.modalModel.body.push(`Hello, ${this.newUser.Name}👋🏼, thank you and welcome to Prosperity.`);
